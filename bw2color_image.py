...
#function to resize the image with respective aspect ratio
#input: either expected height or width
...
image = ResizeWithAspectRatio(image, width=256) # Resize by width
cv2.imshow("Original", image)
colorized = ResizeWithAspectRatio(colorized, width=256) # Resize by width
